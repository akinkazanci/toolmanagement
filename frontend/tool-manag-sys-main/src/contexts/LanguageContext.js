...
const translations = {
  tr: {
    ...
    'dashboard_description': 'Proje Genel Bakış ve İstatistikler',
    'total_personnel': 'Toplam Personel',
    'active_personnel': 'Aktif Personel',
    'inactive_personnel': 'İnaktif Personel',
    'department_distribution': 'Departmanlara Göre Personel Dağılımı',
    'location_distribution': 'Lokasyonlara Göre Personel Dağılımı',
    'application_distribution': 'Uygulamalara Göre Personel Dağılımı',
    ...
    'import_from_jira': "Jira'dan İçe Aktar",
    'add_project': 'Proje Ekle',
    'project_name': 'Proje Adı',
    'project_key': 'Proje Anahtarı',
    'jira_url': 'Jira URL\'si',
    'enter_project_name': 'Proje adını girin',
    'enter_project_key': 'Proje anahtarını girin',
    'enter_jira_url': 'Jira URL\'sini girin',
    'enter_project_description': 'Proje açıklamasını girin',
    'search_projects': 'Projeleri ara...',
    'project_management_title': 'Proje Yönetimi',
    'project_management_desc': 'Sistem projelerini yönetin',
    'settings_title': 'Ayarlar',
    'settings_subtitle': 'Sistem ayarlarını yönetin',
    ...
    'enter_permission_name': 'İzin adını girin',
    ...
    'edit_user': 'Edit user',
    'dashboard_description': 'Project Overview and Statistics',
    'total_personnel': 'Total Personnel',
    'active_personnel': 'Active Personnel',
    'inactive_personnel': 'Inactive Personnel',
    'department_distribution': 'Personnel Distribution by Department',
    'location_distribution': 'Personnel Distribution by Location',
    'application_distribution': 'Personnel Distribution by Application',
    ...
    'enter_project_key': 'Enter project key',
    'enter_jira_url': 'Enter Jira URL',
