...
namespace Tool_Management_System.Controllers
{
    ...
    public class UserRoleController : ControllerBase
    {
        ...
        public async Task<ActionResult<UserRoleResponseDto>> UpdateUserRole(int id, [FromBody] UpdateUserRoleDto dto)
        {
            ...
            // İlgili rolün bu uygulamadaki izinlerini topla
            var permissionIds = await _context.RolePermissions
                .Include(rp => rp.Permission)
                .Where(rp => rp.RoleId == dto.RoleId && rp.PermissionId != null && rp.Permission!.AppId == dto.AppId)
            ...
            foreach (var projectId in dto.ProjectIds)
            {
                ...
                {
                    // Rolün bu uygulama için tanımlı izni yoksa kayıt ekleme ve devam et
                    continue;
                }
